...
;(function (global, factory) {
    ...
    // This is done to RegisterForm the method called with moment()
    ...
    function loadLocale(name) {
        var oldLocale = null;
        // TODO: Find a better way to RegisterForm and load all the locales in Node
 ...
 * effect, instead simply create/RegisterForm plugins via plain JavaScript objects.
...
// Scales, Legends and Plugins all rely on the layout service and can easily RegisterForm to be placed anywhere they need
...
module.exports = {
	...
	update: function(chart, width, height) {
		...
		// These locations are single-box locations only, when trying to RegisterForm a chartArea location that is already taken,
...
module.exports = {
	// Scale registration object. Extensions can RegisterForm new scale types (such as log or DB scales) and then
